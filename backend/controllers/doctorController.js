...
// Save or update patient report card (doctor-initiated)
const saveOrUpdatePatientReportCard = async (req, res) => {
  try {
    ...
    const notification = new notificationModel({
      ...
      type: "report_card_available", // Set type to identify this as a report card notification
    });
    await notification.save();

    const io = req.app.get("io");
    // Emit the notification with type included for frontend handling
    io.to(userId).emit("newNotification", {
      _id: notification._id,
      message: notification.message,
      type: notification.type, // Critical for frontend navigation
