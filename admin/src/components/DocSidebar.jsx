...
const DocSidebar = () => {
    ...
    const activeStyle = "bg-gradient-to-r from-green-600 to-teal-500 text-white shadow-md";
    const inactiveStyle = "text-gray-700 hover:bg-teal-50";
                    ...
                    <div className="flex flex-col h-screen">
                        ...
                        <div className="h-20 flex items-center px-6 border-b border-gray-200">
                            <div className="flex items-center space-x-3">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-600 to-teal-400 flex items-center justify-center">
                                    <span className="text-white font-bold text-lg">D</span>
                                </div>
                                <h1 className="text-xl font-bold bg-gradient-to-r from-green-600 to-cyan-600 text-transparent bg-clip-text">Doctor Portal</h1>
                            </div>
                        </div>
                        ...
                        {/* Doctor profile section at bottom - Static text removed */}
