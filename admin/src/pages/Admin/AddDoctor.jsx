...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append("degree", degree); // Fixed key name
      formData.append(
        "address",
        JSON.stringify({ line1: address1, line2: address2 })
      );

      console.log("Sending token:", aToken); // Debug token transmission
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-800 relative after:content-[''] after:absolute after:w-20 after:h-1 after:bg-primary after:left-0 after:bottom-[-8px]">Add Doctor</h2>
        <button type="submit" className="bg-primary hover:bg-opacity-90 transition-all px-10 py-3 text-white rounded-lg shadow-lg flex items-center gap-2">
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="bg-gradient-to-r from-primary to-primary bg-opacity-10 p-6 border-b">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-700">Upload Doctor Photo</h3>
              <p className="text-sm text-gray-500">Select a professional photo of the doctor</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                <label className="text-sm font-medium text-gray-600 block mb-1">Consultation Fee</label>
                <div className="relative">
            ...
            {/* Right Column */}
            <div className="space-y-6">
              <h3 className="text-lg font-medium text-gray-700 border-b pb-2">Professional Details</h3>
              ...
              <div className="relative">
                <label className="text-sm font-medium text-gray-600 block mb-1">Education Qualification</label>
                <input 
              ...
              <div className="space-y-3">
                <label className="text-sm font-medium text-gray-600 block">Doctor Address</label>
                <input 
          ...
          <div className="mt-8">
            <label className="text-sm font-medium text-gray-600 block mb-2">About Doctor</label>
            <div className="relative">
              <textarea 
