        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/3 bg-indigo-600 text-white p-6">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl font-semibold text-center text-white">{profileData.name}</h2>
              <p className="text-gray-200 text-center mb-2 text-sm">{profileData.degree}</p>
              <p className="text-gray-100 text-center font-medium mb-4 text-sm">{profileData.speciality}</p>
              
              <div className="flex items-center justify-center gap-2 mb-6">
                <span className="px-3 py-1 bg-indigo-600/20 rounded-full text-xs font-medium text-white">{profileData.experience}</span>
                <span className={`px-3 py-1 ${profileData.available ? 'bg-green-600' : 'bg-red-600'} rounded-full text-xs font-medium text-white`}>
                  {profileData.available ? 'Available' : 'Unavailable'}
                </span>
              </div>
              
              <div className="w-full pt-4 border-t border-gray-200">
                <h3 className="text-sm font-semibold uppercase tracking-wider mb-2 text-gray-100">Contact Information</h3>
          ...
          <div className="md:w-2/3 p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-sm">{profileData.about}</p>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-sm font-semibold text-gray-600">Appointment Fee</h3>
                      {isEdit ? (
                        ...
                        <p className="text-lg font-medium text-gray-900">{currency} {profileData.fee}</p>
                      )}
                    </div>
                    
                    <div>
                      <h3 className="text-sm font-semibold text-gray-600">Availability Status</h3>
                      <div className="flex items-center mt-2">
                        <label className="inline-flex items-center cursor-pointer">
                          ...
                          <div className={`relative w-14 h-7 bg-gray-300 rounded-full peer 
                            ...
                            ${profileData.available ? 'peer-checked:bg-green-600' : 'peer-checked:bg-red-600'}
                            ${!isEdit ? 'opacity-70' : ''}
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-indigo-600/10 text-gray-600 rounded-full text-sm font-medium">{profileData.degree}</span>
                  <span className="px-3 py-1 bg-indigo-600/10 text-gray-600 rounded-full text-sm font-medium">{profileData.speciality}</span>
                  <span className="px-3 py-1 bg-indigo-600/10 text-gray-600 rounded-full text-sm font-medium">{profileData.experience}</span>
                </div>
              </div>
            </div>
          </div>
